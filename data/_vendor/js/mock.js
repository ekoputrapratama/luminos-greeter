...
class ConfigFile {
   ...
   */
  get_bool(key) {
    return key in this._mock_data.config
      ? Boolean(this._mock_data.config[key])
      : false;
  }
  ...
  get_num(key) {
    return key in this._mock_data.config
      ? parseInt(this._mock_data.config[key])
      : 0;
  }
    ...
    for (let property_type of Object.keys(this._mock_data.greeter.properties)) {
      for (let property of this._mock_data.greeter.properties[property_type]) {
        if (property.indexOf("can_") > -1) {
          ...
          this[`_${property}`] = this._mock_data.greeter.default_values[
            property_type
          ]();
        }
      }
  ...
  users: [
    {
      ...
      language: null,
      layout: null,
      image: "/usr/share/lightdm-webkit/themes/manjaro/img/manjaro-logo-user",
...
config.get_str = function(section, key) {
  var branding = {
    logo: "img/manjaro.png",
    user_logo: "ing/manjaro-logo-user.png",
    background_images: "/usr/share/manjaro/wallpapers"
  };
  if ("branding" === section) {
    return branding[key];
  }
...
greeterutil.dirlist = function(directory) {
  if ("/usr/share/manjaro/wallpapers" === directory) {
    return [
      "/usr/share/manjaro/wallpapers/83II_by_bo0xVn.jpg",
      "/usr/share/manjaro/wallpapers/manjaro-wallpaper.png",
      "/usr/share/manjaro/wallpapers/as_time_goes_by____by_moskanon-d5dgvt8.jpg",
      "/usr/share/manjaro/wallpapers/autumn_hike___plant_details_by_aoiban-d5l7y83.jpg",
      "/usr/share/manjaro/wallpapers/blossom_by_snipes2.jpg",
      "/usr/share/manjaro/wallpapers/c65sk3mshowxrtlljbvh.jpg",
      "/usr/share/manjaro/wallpapers/early_morning_by_kylekc.jpg",
      "/usr/share/manjaro/wallpapers/extinction_by_signcropstealer-d5j4y84.jpg",
      "/usr/share/manjaro/wallpapers/field_by_stevenfields-d59ap2i.jpg",
      "/usr/share/manjaro/wallpapers/Grass_by_masha_darkelf666.jpg",
      "/usr/share/manjaro/wallpapers/Grass_Fullscreen.jpg",
      "/usr/share/manjaro/wallpapers/humble_by_splendidofsun-d5g47hb.jpg",
      "/usr/share/manjaro/wallpapers/In_the_Grass.jpg",
      "/usr/share/manjaro/wallpapers/morning_light.jpg",
      "/usr/share/manjaro/wallpapers/Nautilus_Fullscreen.jpg",
      "/usr/share/manjaro/wallpapers/nikon_d40.jpg",
      "/usr/share/manjaro/wallpapers/sky_full_of_stars.jpg",
      "/usr/share/manjaro/wallpapers/solely_by_stevenfields.jpg",
      "/usr/share/manjaro/wallpapers/the_world_inside_my_lens__by_moskanon-d5fsiqs.jpg",
      "/usr/share/manjaro/wallpapers/white_line_by_snipes2.jpg"
    ];
  }
};
